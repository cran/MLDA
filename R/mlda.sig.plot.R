`mlda.sig.plot` <-
function(score.obj,pvalue=0.05,control1=NULL,control2=NULL,control3=NULL){
...
plot(score1,score2,xlab="averaged sensitive score",ylab="averaged resistant score",pch=".")
...
legend("bottomright",c("positive","negative","control1","control2","control3"),col=c(2,4,3,5,6),pch=16,cex=0.6)
